        ...
        <div className="container-custom relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.h1 
              ...
              className="heading-xl text-light-brighter mb-6"
            >
              AI is Everywhere.<br />
            ...
            <motion.div 
              ...
              className="mb-8 p-4 bg-neutral-card rounded-lg border border-neutral-border hover:border-primary/50 transition-colors"
            >
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  <motion.button 
                    ...
                    className="inline-flex items-center justify-center px-10 py-4 border border-transparent text-lg font-medium rounded-lg text-white bg-primary hover:bg-primary/90 transition-colors whitespace-nowrap"
                  >
                  ...
                  >
                    <Link 
                      href="/pricing" 
                      className="inline-flex items-center justify-center px-10 py-4 border border-white/20 text-lg font-medium rounded-lg text-white hover:bg-white/10 transition-colors whitespace-nowrap"
                    >
                      View Pricing
                    </Link>
                  </motion.div>
              ...
              <motion.div 
                ...
                transition={{ duration: 0.5 }}
                viewport={{ once: true }}
                className="relative max-w-xl justify-self-end"
              >
                <div className="absolute inset-0 bg-gradient-radial from-primary/20 to-transparent opacity-50"></div>
                <div className="relative bg-neutral-800/50 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-primary/30 transition-colors">
                  ...
                  <ul className="space-y-4">
                    ...
                    >
                      ...
                      <span className="text-neutral-300">Get your free AI audit in one week</span>
                    </motion.li>
                    <motion.li 
                      initial={{ x: -20, opacity: 0 }}
                      whileInView={{ x: 0, opacity: 1 }}
                    ...
                    >
                      <FaCheckCircle className="w-5 h-5 text-primary mt-1" />
                      <span className="text-neutral-300">Receive 3 popular Solution Threads</span>
                    </motion.li>
                    <motion.li 
                      initial={{ x: -20, opacity: 0 }}
                      whileInView={{ x: 0, opacity: 1 }}
                    ...
                    >
                      <FaCheckCircle className="w-5 h-5 text-primary mt-1" />
                      <span className="text-neutral-300">Start implementing AI today</span>
                    </motion.li>
                  </ul>
                </div>
              </motion.div>
      ...
      <section className="section-padding bg-neutral">
        <div className="container-custom">
          ...
          >
            ...
            <h2 className="heading-lg mb-6">Your AI Journey Starts Here</h2>
            <p className="text-xl text-light/80 max-w-3xl mx-auto">
              We don't just implement AI—we create custom processes that fit your business like a glove. No technical expertise needed, just clear guidance every step of the way.
            </p>
          </motion.div>
